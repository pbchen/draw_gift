...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <h3 class="heading">商品分类列表</h3>
        <div class="w-box-header">
            <div class="pull-left sort-disabled margin-left-2">
                <input name="s_name" class="input-medium form-control" placeholder="分类名称" type="text">
            </div>
            <div class="pull-left sort-disabled margin-left-2">
                <input name="s_id" class="input-medium form-control" placeholder="分类id" type="text">
            </div>
            <div class="pull-left sort-disabled margin-left-2">
        ...
        <div class="w-box-header">
            <div class="pull-left sort-disabled">
                <a class="btn btn-success label" id="add-classify">新建</a>
                <a class="btn btn-success label margin-left-2" id="stop-classify">停用</a>
                <a class="btn btn-success label margin-left-2" id="start-classify">启用</a>
            </div>
        </div>
        <table class="table table-striped table-bordered dTableR" id="classify_tb">
            <thead>
                <tr>
                    <th class="table_checkbox center">
                        <input name="select_rows" class="select_rows" data-tableid="classify_tb" type="checkbox">
                    </th>
...
<!---------新建弹层---------->
<div class="modal fade" id="add-classify-modal">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" class="center">
                                <button type="button" class="btn btn-success" id="add-classify-bnt">确认</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<!---------编辑弹层---------->
<div class="modal fade" id="edit-classify-modal">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-max-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="modal-body">
                <table class="table table-condensed table-striped">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" class="center">
                                <button type="button" class="btn btn-success" id="edit-classify-bnt">确认</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
