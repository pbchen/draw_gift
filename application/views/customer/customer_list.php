...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <h3 class="heading">商品客户列表</h3>
        <div class="w-box-header">
            <div class="pull-left sort-disabled margin-left-2">
                <input name="s_name" class="input-medium form-control" placeholder="客户名称" type="text">
            </div>
            <div class="pull-left sort-disabled margin-left-2">
                <input name="s_id" class="input-medium form-control" placeholder="客户id" type="text">
            </div>
            <div class="pull-left sort-disabled margin-left-2">
        ...
        <div class="w-box-header">
            <div class="pull-left sort-disabled">
                <a class="btn btn-success label" id="add-customer">新建</a>
        ...
        <table class="table table-striped table-bordered dTableR" id="customer_tb">
            <thead>
                <tr>
                    <th class="table_checkbox center">
                        <input name="select_rows" class="select_rows" data-tableid="customer_tb" type="checkbox">
                    </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" class="center">
                                <button type="button" class="btn btn-success" id="add-customer-bnt">确认</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="modal-body">
                <table class="table table-condensed table-striped">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" class="center">
                                <button type="button" class="btn btn-success" id="edit-customer-bnt">确认</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
