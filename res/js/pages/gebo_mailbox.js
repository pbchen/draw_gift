/* [ ---- Gebo Admin Panel - mailbox ---- ] */
    ...
    gebo_mailbox = {
        inbox: function() {
			...
			$('#dt_inbox_wrapper .dt_actions a').addClass('bs_ttip').attr({
        ...
        outbox: function() {
			...
			//* add tootlips for buttons
			$('#dt_outbox_wrapper .dt_actions a').addClass('bs_ttip').attr({
				'data-placement': "auto top",
				'data-container': "body",
				'data-viewport': "body"
			});
        ...
        trash: function() {
			...
			//* add tootlips for buttons
			$('#dt_trash_wrapper .dt_actions a').addClass('bs_ttip').attr({
				'data-placement': "auto top",
				'data-container': "body",
				'data-viewport': "body"
			});
